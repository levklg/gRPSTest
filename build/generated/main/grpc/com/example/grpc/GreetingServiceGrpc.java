...
public final class GreetingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.GreetingServiceOuterClass.Request,
      com.example.grpc.GreetingServiceOuterClass.Empty> getSetRequestMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "setRequest",
      requestType = com.example.grpc.GreetingServiceOuterClass.Request.class,
      responseType = com.example.grpc.GreetingServiceOuterClass.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.GreetingServiceOuterClass.Request,
      com.example.grpc.GreetingServiceOuterClass.Empty> getSetRequestMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.GreetingServiceOuterClass.Request, com.example.grpc.GreetingServiceOuterClass.Empty> getSetRequestMethod;
    if ((getSetRequestMethod = GreetingServiceGrpc.getSetRequestMethod) == null) {
      synchronized (GreetingServiceGrpc.class) {
        if ((getSetRequestMethod = GreetingServiceGrpc.getSetRequestMethod) == null) {
          GreetingServiceGrpc.getSetRequestMethod = getSetRequestMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.GreetingServiceOuterClass.Request, com.example.grpc.GreetingServiceOuterClass.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "setRequest"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.GreetingServiceOuterClass.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.GreetingServiceOuterClass.Empty.getDefaultInstance()))
              .setSchemaDescriptor(new GreetingServiceMethodDescriptorSupplier("setRequest"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.GreetingServiceOuterClass.Request,
      com.example.grpc.GreetingServiceOuterClass.Response> getGetResponseMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getResponse",
      requestType = com.example.grpc.GreetingServiceOuterClass.Request.class,
      responseType = com.example.grpc.GreetingServiceOuterClass.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpc.GreetingServiceOuterClass.Request,
      com.example.grpc.GreetingServiceOuterClass.Response> getGetResponseMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.GreetingServiceOuterClass.Request, com.example.grpc.GreetingServiceOuterClass.Response> getGetResponseMethod;
    if ((getGetResponseMethod = GreetingServiceGrpc.getGetResponseMethod) == null) {
      synchronized (GreetingServiceGrpc.class) {
        if ((getGetResponseMethod = GreetingServiceGrpc.getGetResponseMethod) == null) {
          GreetingServiceGrpc.getGetResponseMethod = getGetResponseMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.GreetingServiceOuterClass.Request, com.example.grpc.GreetingServiceOuterClass.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.GreetingServiceOuterClass.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.GreetingServiceOuterClass.Response.getDefaultInstance()))
              .setSchemaDescriptor(new GreetingServiceMethodDescriptorSupplier("getResponse"))
              .build();
        }
      }
    }
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    public void setRequest(com.example.grpc.GreetingServiceOuterClass.Request request,
      ...
      asyncUnimplementedUnaryCall(getSetRequestMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.GreetingServiceOuterClass.Request,
                com.example.grpc.GreetingServiceOuterClass.Empty>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.grpc.GreetingServiceOuterClass.Request,
                com.example.grpc.GreetingServiceOuterClass.Response>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.GreetingServiceOuterClass.Empty setRequest(com.example.grpc.GreetingServiceOuterClass.Request request) {
    ...
    /**
     */
    public com.example.grpc.GreetingServiceOuterClass.Response getResponse(com.example.grpc.GreetingServiceOuterClass.Request request) {
      return blockingUnaryCall(
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.GreetingServiceOuterClass.Empty> setRequest(
        com.example.grpc.GreetingServiceOuterClass.Request request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.GreetingServiceOuterClass.Response> getResponse(
        com.example.grpc.GreetingServiceOuterClass.Request request) {
      return futureUnaryCall(
  ...
  private static final int METHODID_GET_RESPONSE = 2;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_SET_REQUEST:
          serviceImpl.setRequest((com.example.grpc.GreetingServiceOuterClass.Request) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.GreetingServiceOuterClass.Empty>) responseObserver);
          break;
        case METHODID_GET_RESPONSE:
          serviceImpl.getResponse((com.example.grpc.GreetingServiceOuterClass.Request) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.GreetingServiceOuterClass.Response>) responseObserver);
          break;
        default:
